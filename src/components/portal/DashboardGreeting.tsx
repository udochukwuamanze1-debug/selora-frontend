      ...
      <div className="glass-card p-6 mb-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-row items-stretch sm:items-center gap-4">
            ...
            {/* Avatar Mint Box */}
            <div className="glass-card-hover p-4 rounded-2xl flex flex-col sm:flex-row lg:flex-row items-stretch sm:items-center gap-4 justify-center min-w-[140px] border border-primary/20">
